...
if __name__ == '__main__':
    with open('16 nov 14 shift.json') as f:
        employees = json.loads(f.read())

    with open('16 nov 14 dm.json') as f:
        distance_matrix = json.loads(f.read())

        cab_types = ['INDICA', 'SUMO', 'TRAVELLER']
    price = [15, 15, 20]
    with open('16 nov 14 h2o.json') as f:
    ...
    with open('result 16 nov 14.json') as f:
    ...
    with open('our 16 nov 14.js', 'w') as f:
        f.write(json.dumps(our_stats))
    with open('their 16 nov 14.js', 'w') as f:
